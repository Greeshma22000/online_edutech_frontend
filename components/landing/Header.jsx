    ...
    <header className="w-full border-b border-b-amber-600 bg-white/80 backdrop-blur">
        <div className='max-w-6xl mx-auto flex items-center justify-between px-4 py-4'>
            <Link href="/" className='font-semibold text-xl md:text-2xl flex items-center gap-2'>
                <span className='inline-flex h-10 w-10 items-center justify-center rounded-full text-white shadow-md' style={{backgroundImage: 'linear-gradient(135deg, #240046 0%, #f7b267 100%'}}>O</span>
            ...
            <nav className='flex items-center gap-5'>
                ...
                {user ? (
                    ...
                    <>
                        ...
                        <Link href="/register" className='text-base inline-flex items-center rounded-md text-white px-4 py-2 hover:opacity-90 shadow-2xl' style={{backgroundImage: 'linear-gradient(135deg, #f25c54 0%, #f7b267 100%'}}>Sign up</Link>
                    </>
                )}
            </nav>
        </div>
