      ...
      <div className="w-full max-w-xl rounded-3xl border border-amber-500 border-brand-100 bg-white p-9 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-8">
          ...
          <div>
            ...
            <input className="mt-1.5 w-full border border-amber-500 rounded-xl p-3.5 text-lg focus:outline-none focus:ring-2 focus:ring-brand-500" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" />
          </div>
