      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <form className="relative rounded-2xl bg-white p-6 shadow-lg border border-gray-100 overflow-hidden" onSubmit={(e) => { e.preventDefault(); onSaveProfile?.({ name }); }}>
          ...
          <div className="relative">
            ...
            <button className="w-full inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm font-medium text-white shadow-md hover:shadow-lg transition" style={{ backgroundImage: 'linear-gradient(135deg,#6366f1 0%, #06b6d4 100%)' }}>Save Changes</button>
          </div>
        </form>
        ...
        <form className="relative rounded-2xl bg-white p-6 shadow-lg border border-gray-100 overflow-hidden" onSubmit={(e) => { e.preventDefault(); onChangePassword?.({ password }); setPassword(''); }}>
          ...
          <div className="relative">
            ...
            <button className="w-full inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm font-medium text-white shadow-md hover:shadow-lg transition" style={{ backgroundImage: 'linear-gradient(135deg,#6366f1 0%, #06b6d4 100%)' }}>Update Password</button>
          </div>
        </form>
      </div>
    </section>
